...
public @interface Property {
    ...
    Type.FOLDER
        Can be toggled open and closed. Not saved in config file. When closed, settings preserve their state.
    ...
    Type.CHECKBOX
        Functions the same as Type.BOOLEAN, just with a different appearance.
