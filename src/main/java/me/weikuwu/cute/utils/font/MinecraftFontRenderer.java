...
public class MinecraftFontRenderer extends CFont {
    ...
    public RandomAccess wrapWords(final String text, final double width) {
    ...
    public Collection<? extends String> formatString(final String string, final double width) {
        final ArrayList<String> finalWords = new ArrayList<String>();
        StringBuilder currentWord = new StringBuilder();
        char lastColorCode = '\uffff';
